...
#
#
#This python script is used to show usage of a "super command" that gives you information on the switch you're querying
#This has been created for demo purposes and not for customer deployment
#1/4/2015 Rich Grayson rgrayson@cisco.com
...
print("\nGETTING REQUESTED SWITCH INFO\n=============================")




#  obtain hostname, chassis ID, NXOS version, serial number
...
# "show modules"
dom = minidom.parse(ExecuteiAPICommand(ip, cookie, basicauth, "cli_show", "show module"))
...
dom = minidom.parse(ExecuteiAPICommand(ip, cookie, basicauth, "cli_show", "show interface mgmt0"))
eth_ip_addr=GetNodeDataDom(dom,"eth_ip_addr")
eth_hw_addr=GetNodeDataDom(dom,"eth_hw_addr")
print("\nManagement Interface Info:\n==========================")
print("The IP Address is {0}".format(eth_ip_addr))
print("The MAC Address is {0}".format(eth_hw_addr))
...
# show guestshell info                            
dom = minidom.parse(ExecuteiAPICommand(ip, cookie, basicauth, "cli_show", "show virtual-service detail"))
name=GetNodeDataDom(dom,"name")
state=GetNodeDataDom(dom,"state")
package_name=GetNodeDataDom(dom,"package_name")
application_version=GetNodeDataDom(dom,"application_version")
print("\nActive Container Information:\n=============================")
print("The Container Name is {0} The State is {1}".format(name, state)) 
print("The Package Name is {0} The Version is {1}".format(package_name, application_version))
print("\n\n")
